...
def train(datasets, cur, args):
    ...
    # Danh sách để lưu loss theo epoch
    train_loss_history = []
    val_loss_history = []

    for epoch in range(args.max_epochs):
        train_loss = train_loop(args, epoch, model, train_loader, optimizer, args.n_classes, writer, loss_fn)
    ...
    loss_df.to_csv(os.path.join(args.results_dir, f"train_loss_split_{cur}.csv"), index=False)
